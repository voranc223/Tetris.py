...
class Figure:
    ...
    def __init__(self, x, y):  #figuri določi atribute
        ...
        self.type_1 = random.randint(0, len(self.figures) - 1)
...
class Tetris:
    ...
    def zamrzni(self):
        ...
        self.nova_figura()
        self.figure.type = self.figure.type_1
        self.figure.type_1 = random.randint(0, len(self.figure.figures) - 1)
...
while not done:  #glavna zanka
    ...
    screen.fill(blue)
    pygame.draw.rect(screen, (232, 18, 18), [game.x-3, game.y-3, game.zoom * game.width+6, game.zoom * game.height+6], 3)
    pygame.draw.rect(screen, (48, 25, 52), [game.x, game.y, game.zoom * game.width, game.zoom * game.height])
